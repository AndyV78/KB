  ...
  networks: {
    harbinger: {
      ...
      accounts: {
        ...
        contract: {
          privateKey: process.env.HARBINGER_KBCHARS_CONTRACT_PRIVATE_KEY,
          id: process.env.HARBINGER_KBCHARS_CONTRACT_ID,
        },
      },
    },
    mainnet: {
      ...
      accounts: {
        ...
        contract: {
          privateKey: process.env.MAINNET_KBCHARS_CONTRACT_PRIVATE_KEY,
          id: process.env.MAINNET_KBCHARS_CONTRACT_ID,
        },
      },
    },
  },
